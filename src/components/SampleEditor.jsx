    ...
    <div className="editor">
      <div className="editor__header">
          ...
          {packSamples?.length > 0 ? (
            <SamplePicker
              ...
              onSelect={(url, fileName) => {
                ...
                if (window.pendo) {
                  window.pendo.track("sample_selected", {
                    padKey: padKey,
                    fileName: fileName,
                    previousFileName: pad.fileName,
                    packId: activePack,
                  });
                }
              }}
        ...
        <div className="editor__header-actions">
          {onRandomize && (
            <button
              className="editor__randomize"
              onClick={() => onRandomize(padKey)}
              title="Pick random sample from pack"
            >
              ↺
            </button>
          )}
          ...
          <div className="editor__sample-inner">
            ...
            <div className="editor__filter-type">
              <button
                ...
                onClick={() =>
                  onUpdateSettings(padKey, { reverse: !s.reverse })
                }
              >
                REV
              </button>
